"""Tests for kstar solar monitoring api."""
import asyncio

import aiohttp
from custom_components.kstar_solar_monitoring.api import (
    KstarSolarMonitoringApiClient,
)
...
async def test_api(hass, aioclient_mock, caplog):
    ...
    api = KstarSolarMonitoringApiClient("test", "test", async_get_clientsession(hass))
